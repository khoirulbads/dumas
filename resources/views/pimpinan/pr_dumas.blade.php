    ...
    <div class="modal fade text-left" id="statdumas{{$det->DUMAS_ID}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable  modal-sm" role="document">
            <div class="modal-content">
                ...
                <?php
                    $upd = DB::SELECT("select*from tindak_lanjut where DUMAS_ID = '$det->DUMAS_ID'");
                ?>
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" id="contact-info-vertical" class="form-control" name="ket" autocomplete="off" style="height: 270px;resize: none;"></textarea>
                                    </div>
                ...
                <?php }else{?>
                    ...
                    @foreach($upd as $upd2)
                    <form action="/odumas:sta={{$upd2->DUMAS_ID}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                        <div class="modal-body">
                            <div class="form-body">
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="contact-info-vertical">Keterangan</label>
                                        <textarea type="text" id="contact-info-vertical" class="form-control" name="ket" value="{{$upd2->KET}}" autocomplete="off" style="height: 270px;resize: none;"></textarea>
                                    </div>
