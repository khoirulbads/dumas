              ...
              <ul class="menu-content">
                  ...
                  <li>
                    <a href="{{ url('/dataverdumas')}}">
                        <i class="feather icon-circle"></i>
                        <span class="menu-item" data-i18n="eCommerce">telah diverifikasi</span>
                  ...
                  <li>
                    <a href="{{ url('/dataprodumas')}}">
                        <i class="feather icon-circle"></i>
                        <span class="menu-item" data-i18n="eCommerce">sedang diproses</span>
                  ...
                  <li>
                    <a href="{{ url('/datatladumas')}}">
                        <i class="feather icon-circle"></i>
                        <span class="menu-item" data-i18n="eCommerce">telah ditindak</span>
        ...
        <div class="content-wrapper">
            ...
            card-img-right">
                ...
                <section id="statistics-card">
                    ...
                    <center>
                    <div class="col-xl-3 col-md-4 col-sm-6" style="text-align:center;">
                        <div class="card text-center">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="row">
